execute if items entity @s player.cursor structure_void run return run function ender_chest:clear/delete
execute if items entity @s player.cursor gray_stained_glass_pane run return run function ender_chest:clear/delete
execute if items entity @s container.* structure_void run return run function ender_chest:clear/delete
execute if items entity @s container.* gray_stained_glass_pane run return run function ender_chest:clear/delete
execute if items entity @s weapon.offhand structure_void run return run function ender_chest:clear/delete
