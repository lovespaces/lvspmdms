execute if data entity @s Item.components.minecraft:custom_data.IsJoinPaper run function admin:item_execute/join/
execute if data entity @s Item.components.minecraft:custom_data.IsStartPaper run function game:start
execute if data entity @s Item.components.minecraft:custom_data.IsVoiceSetting run function admin:item_execute/voice_setting
