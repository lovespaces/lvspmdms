give @s armor_stand[entity_data={id:"minecraft:armor_stand",NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:0b,Tags:["EnderChest"]},custom_name="EnderChest"] 1
give @s armor_stand[entity_data={id:"minecraft:armor_stand",NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:0b,Tags:["TempChest"]},custom_name="TempChest"] 1
