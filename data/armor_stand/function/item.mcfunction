...
tellraw @s [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"アーマースタンドを設置後、 /function summon:armor_stand/ender_chest or armor_stand/temporary_chest でチェストを設置してください。", "color":"white"}]
tellraw @s [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"※TempChest, Lobby, Escapeは1体だけにしてください※", "color":"white"}]
tellraw @s [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"※EnderChestのスタンド同士はある程度離しておかないとゲーム内でバグる可能性があります※", "color":"white"}]
