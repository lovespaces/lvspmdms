...
execute unless score @s sneaking >= $EscapeSneaks settings run return run tellraw @s [{"text":"[ラブスペ人狼] ", "color":"red"}, {"score":{"name":"$EscapeSneaks", "objective":"settings"}, "color": "aqua"}, {"text":" 秒以上しゃがんでから", "color":"white"}, {"text": "しゃがみながら脱出してください", "color":"white", "bold":true}]
