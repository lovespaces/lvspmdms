...
execute if entity @s[tag=BadGuys] run return run tellraw @s [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"役職上、あなたは脱出できません。", "color":"white"}]
execute if entity @s[team=detective] run return run tellraw @s [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"役職上、あなたは脱出できません。", "color":"white"}]
...
# tellraw @s [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"刺されている状態では脱出できない！", "color":"white"}]
