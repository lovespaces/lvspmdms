scoreboard objectives add dropped.crystall_ball dropped:soul_lantern
scoreboard objectives add dropped.dead_report dropped:book
scoreboard objectives add dropped.bandage dropped:feather
