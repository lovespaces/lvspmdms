...
execute if score @s dropped.player_head matches 1 as @s at @s run function item:special/drop/player_head
...
execute if score @s used.ender_pearl matches 1 run function item:special/ender_pearl
