...
scoreboard players set $RoleLostKey settings 15

scoreboard players set $InnocentEmerald settings 30
scoreboard players set $InnocentKey settings 80
scoreboard players set $InnocentTrash settings 100
scoreboard players set $InnocentLostKey settings 10
