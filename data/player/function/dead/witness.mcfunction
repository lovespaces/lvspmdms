...
tellraw @a [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"目撃者の行方がわからなくなった。", "color":"white"}]
tellraw @a [{"text": "", "bold": false}, {"color":"red","text":"[ラブスペ人狼] ", "bold": true}, {"text":"人狼はあなたを一撃で殺すようになるだろう..."}]
